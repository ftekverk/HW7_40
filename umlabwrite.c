...
extern void build_mult_div_test(Seq_T stream);
...
extern void build_fifty_mil(Seq_T stream);
...
static struct test_info {
        ...
        { "halt-verbose", NULL, NULL,     build_verbose_halt_test },
        // { "add",          NULL, "",     build_add_test},
        { "print-six",    NULL, NULL,     build_print_digit_test},
        { "cond_move",    NULL, NULL,     build_cond_move_test},
        { "mult_div",     NULL, NULL,     build_mult_div_test},
        { "nand",         NULL, NULL,     build_nand_test},
        { "map_unmap",    NULL, NULL,     build_map_unmap_test},
        { "seg_load",     NULL, NULL,     build_seg_load_store_test},
        { "load_prog",    NULL, NULL,     build_load_prog_test},
        { "50_mil_bby",   NULL, NULL,     build_fifty_mil},
        { "input",        NULL, NULL,     build_input_test},
